...
""" An abstract class for ConnectFourPlayers, either human or AI.
"""
class ConnectFourPlayer(ABC) :
    ...
    """ For instantiating settings, including name. Should prompt user for 
        things like depth limit or time limit, if relevant 
    """
    @abstractmethod
